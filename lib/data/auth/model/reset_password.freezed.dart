...
abstract class $ResetPasswordRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? otp, String? newPassword, String? userId});
}
...
class _$ResetPasswordRequestImpl implements _ResetPasswordRequest {
  const _$ResetPasswordRequestImpl({this.otp, this.newPassword, this.userId});
  ...
  @override
  String toString() {
    return 'ResetPasswordRequest(otp: $otp, newPassword: $newPassword, userId: $userId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, otp, newPassword, userId);
...
abstract class _ResetPasswordRequest implements ResetPasswordRequest {
  const factory _ResetPasswordRequest(
      {final int? otp,
      final String? newPassword,
      final String? userId}) = _$ResetPasswordRequestImpl;
