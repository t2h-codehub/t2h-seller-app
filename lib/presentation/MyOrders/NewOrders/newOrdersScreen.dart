...
//   final String? orderFeatures; // ✅ Marked as final
...
//   late Future<List<NewOrdersItems>> _future;  // ✅ Correct type

//   @override
//   void initState() {
//     print("order screen ${widget.orderFeatures}");
//     super.initState();
//     _future = loadAllNewOrders(); // ✅ Directly assign the Future
//   }
...
//             return Center(child: Text("No orders found.")); // ✅ Show empty state
//           }
...
//               NewOrdersItems order = snapshot.data![index];
...
//             _buildTextRow("Order Status:", order.orderStatus, color: Colors.green),
...
//         ),
//       ),
//       SizedBox(width: 4), // Adds some spacing
//       Expanded( 
//         child: Text(
//           value,
//           style: TextStyle(
...
//     Map<String, dynamic> body = {"sellerId": "${_userDetailService.userDetailResponse?.user?.id}"};
...
//   //   orderDetailsReviewModelAndStatusCode = await _orderControllers.getOrderDetails(body);
...
//   void getOrderDetails(String id) async {
//   Map<String, String> body = {"orderId": id}; // ✅ Use Map<String, String>
