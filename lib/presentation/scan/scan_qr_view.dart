...
//   Future<String?> scanQRCodeFromImage(String imagePath) async {
//   final barcodeScanner = BarcodeScanner();
//   final inputImage = InputImage.fromFilePath(imagePath);

//   // Process the image and get the detected barcodes
//   final barcodes = await barcodeScanner.processImage(inputImage);

//   if (barcodes.isNotEmpty) {
//     // Assuming the first barcode is the QR code
//     return barcodes.first.value.displayValue;
//   } else {
...
// }
  ...
  if (image != null) {
    // String? result = await scanQRCodeFromImage(image.path);
