...
import 'package:swapnil_s_application4/data/productCategoryModel/changeUsernameApiResModel.dart';
                      ...
                      onTap: () {
                        Share.share((_userDetailService
                                ...
                                _userDetailService
                                        .userDetailResponse?.user?.username !=
                                    null)
                            ? "Grow your fashion business effortlessly with a Free eCommerce website from TaptoHello. Click https://myhello.store/${_userDetailService.userDetailResponse?.user?.username}"
                            : "Grow your fashion business effortlessly with a Free eCommerce website from TaptoHello. Click https://myhello.store/${_userDetailService.userDetailResponse?.user?.id}");
                        print(
                            "Grow your fashion business effortlessly with a Free eCommerce website from TaptoHello. Click https://myhello.store/${_userDetailService.userDetailResponse?.user?.id}");
                      },
                      child: Container(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          _userDetailService.userDetailResponse?.user?.username == null ? 'https://myhello.store/${_userDetailService.userDetailResponse?.user?.id}' : "https://myhello.store/${_userDetailService.userDetailResponse?.user?.username}",
                                          style: TextStyle(
                                            color: AppCol.gray900,
                                            fontSize: 14,
                                            fontFamily: 'Roboto',
