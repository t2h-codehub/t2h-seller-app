                      ...
                      onTap: () {
                        Share.share((_userDetailService
                                ...
                                _userDetailService
                                        .userDetailResponse?.user?.username !=
                                    null)
                            ? "Grow your online business effortlessly with your HelloStore eCommerce website from TaptoHello. Click ${AppConstants.storeUrl}${_userDetailService.userDetailResponse?.user?.username}"
                            : "Grow your online business effortlessly with your HelloStore eCommerce website from TaptoHello. Click ${AppConstants.storeUrl}${_userDetailService.userDetailResponse?.user?.id}");
                        print(
                            "Grow your online business effortlessly with your HelloStore eCommerce website from TaptoHello. Click ${AppConstants.storeUrl}${_userDetailService.userDetailResponse?.user?.id}");
                      },
                      child: Container(
