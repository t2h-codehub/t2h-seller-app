              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        _launchURL('https://taptohello.com/leads/${_userDetailService.userDetailResponse?.user?.id}');
                        // Navigator.of(context).pop();
                        // showWebView();
                        /// Create Another Profile
                       /* Navigator.of(context).push(MaterialPageRoute(
    ...
    controller = WebViewController()
      ...
      ..setNavigationDelegate(NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) {
            if (!request.url
                .startsWith('https://taptohello.com/leads/${_userDetailService.userDetailResponse?.user?.id}')) {
      ...
      ..loadRequest(Uri.parse("https://taptohello.com/leads/${_userDetailService.userDetailResponse?.user?.id}"));
