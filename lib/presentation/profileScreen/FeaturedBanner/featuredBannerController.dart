...
class FeaturedBannerControllers {
  ...
  // Method to post banners to the API
...
//   var data = json.encode({"banners": banners});

//   print("Request Model (Payload): ${jsonEncode(data)}");
...
//       if (context.mounted) {
//         DialogBuilder(context).hideOpenDialog(); // ✅ Hide loading before showing dialog

//         // ✅ Ensure the dialog is properly displayed
//         await Future.delayed(Duration(milliseconds: 200)); // Prevent UI lag
//         await showDialog(
//           context: context,
//           barrierDismissible: false, // Prevent instant dismissal
//           builder: (context) => const FeaturedBannerDialog(),
//         );
//       }
//     } else {
//       print("Error: ${response.statusMessage}");
//       Fluttertoast.showToast(msg: 'Failed to upload banners: ${response.statusMessage}');
//     }
//   } catch (e) {
//     print("Error posting banner: $e");
//     Fluttertoast.showToast(msg: 'Error occurred while uploading banners!');
//   } finally {
//     if (context.mounted) {
