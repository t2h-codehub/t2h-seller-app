...
import 'package:swapnil_s_application4/presentation/profileScreen/ManageCoupons/view/createDiscountCoupons/couponDetailsScreen.dart';
      ...
      children: [
        ...
        Expanded(
          child: ListView.builder(
            ...
            // children: [
            //
            //   _buildCouponCard(context,'REPEAT30', '30% Discount for repeat customers'),
            //   _buildCouponCard(context,'HAPPYBIRTHDAY10',
            //       '10% Discount for all Customers for their birthday'),
            // ],
          ),
        ),
      ],
