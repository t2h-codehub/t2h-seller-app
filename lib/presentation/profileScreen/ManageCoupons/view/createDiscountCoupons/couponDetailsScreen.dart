...
class _CouponDetailsScreenState extends State<CouponDetailsScreen> {
  ...
  TextEditingController _couponCodeValue = TextEditingController();
  TextEditingController _descriptionValue = TextEditingController();
  TextEditingController _skuIDValue = TextEditingController();
  TextEditingController _fromDateValue = TextEditingController();
  TextEditingController _toDateValue = TextEditingController();
  TextEditingController _minimumOrderValue = TextEditingController();
  TextEditingController _specificCustomerValue = TextEditingController();
  TextEditingController _usagePerCustomerValue = TextEditingController();
