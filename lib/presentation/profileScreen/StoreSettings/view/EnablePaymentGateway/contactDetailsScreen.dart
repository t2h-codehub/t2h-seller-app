...
class _ContactDetailsScreenState extends State<ContactDetailsScreen> {
  ...
  _selectedSubCategory = widget.getApiDetails.data?.businessSubCategory != "" ? widget.getApiDetails.data?.businessSubCategory : null; // Default to first item if available
    ...
    // businessAddress.text = SharedPreferenceService.getString("paymentBusinessAddress") ?? '';
    // businessPincode.text = SharedPreferenceService.getString("paymentBusinessPostalCode") ?? '';
    // businessCity.text = SharedPreferenceService.getString("paymentBusinessCity") ?? '';
    // businessState.text = SharedPreferenceService.getString("paymentBusinessState") ?? '';
    // debugPrint('My saved business pan is: ${personName.text}');
    // debugPrint('My saved business pan is: ${personEmail.text}');
    // debugPrint('My saved business pan is: ${businessAddress.text}');
    // debugPrint('My saved business pan is: ${businessPincode.text}');
  ...
  Widget build(BuildContext context) {
    // _selectedEntityType = (widget.getApiDetails.data?.businessEntityType ?? '').isEmpty ? "" : '${widget.getApiDetails.data?.businessEntityType}';
    // _selectedCategory = widget.getApiDetails.data?.businessCategory ?? '';
    // _selectedSubCategory = widget.getApiDetails.data?.businessSubCategory ?? '';
    return Padding(
