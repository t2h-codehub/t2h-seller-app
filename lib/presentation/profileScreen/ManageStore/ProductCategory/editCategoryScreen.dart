...
class _EditCategoryScreenState extends State<EditCategoryScreen> {
  ...
  TextEditingController _categoryValueController = TextEditingController();
  TextEditingController _subCategoryValueController = TextEditingController();
  TextEditingController _adminCategoryValueController = TextEditingController();
                              ...
                              child:  InkWell(
                                onTap: () {
                                  if(_subCategoryValueController.text == "") {
                                    ...
                                    // selectedSubcategories.add("${_subCategoryValueController.text}");
                                    */
                            /*_categories[index]['subcategories'].add(
                                      '${_subCategoryValueController.text.trim()}');*/
                            /*
                                    setState(() {});
