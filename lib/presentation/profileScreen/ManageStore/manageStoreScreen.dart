...
import 'package:swapnil_s_application4/presentation/profileScreen/ManageCoupons/view/manageDiscountCouponsMainScreen.dart';
...
import 'package:swapnil_s_application4/presentation/profileScreen/ManageStore/StorePolicy/storePolicyScreen.dart';
import 'package:swapnil_s_application4/presentation/profileScreen/StoreSettings/view/storeSettingsMainScreen.dart';
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () {
                    ...
                    else if (storeFeatures[index] == 'Store Policy') {
                      Navigator.of(context).push(
                        MaterialPageRoute(
