...
// Future<EditProductApiResModel> getProductDetails(String userId, String productId) async {
//   EditProductApiResModel editProductApiResModel = EditProductApiResModel();
...
//       'https://api.mysocio.shop/user/get-seller-product-details/$userId/$productId',
//       options: Options(
//         method: 'GET',
//         headers: headers,
//       ),
...
//       editProductApiResModel = EditProductApiResModel.fromMap(response.data);
//     } else {
//       print("Error: ${response.statusMessage}");
//     }
//   } catch (e) {
