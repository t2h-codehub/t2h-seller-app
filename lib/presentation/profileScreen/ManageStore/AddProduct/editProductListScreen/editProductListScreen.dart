...
//  import 'package:html/dom.dart'; // For working with DOM elements
...
// Define the provider globally
// StateNotifier to manage images
...
class _EditProductListScreenState extends ConsumerState<EditProductListScreen> {
   ...
   */
// Add a post frame callback to check after the first frame is drawn
    // WidgetsBinding.instance.addPostFrameCallback((_) {
    //   // This will be called after the first frame, ensuring the editor is initialized
    //   setState(() {
    //     _isEditorReady = true;
    //     htmlData(); // Set the editor to ready
    //   });
    //   print("Editor is ready (after widget is rendered)!");
    // });

      // Simulate loading future
    // Simulate loading future
    // Simulate loading future (to replace with actual API call)

 // Run the reset logic only the first time
...
String? findIdByTitle(String title) {
 ...
 // Method to save image and get its path
  ...
  // void _getJsonData() {
  //   // Convert the document to Delta, then to JSON format
  //    json = jsonEncode(_productDescriptionController.document.toDelta().toJson());
  //    print("hello hello JSON ${json}");
  //    List<dynamic> deltaJson = jsonDecode(json);
  //   final htmlContent = convertQuillDeltaToHtml(deltaJson);
  //   json = htmlContent;
  //   print("hello hello ${json}");
  // }

 

  // String convertQuillDeltaToHtml(List<dynamic> delta) {
  //   final StringBuffer htmlBuffer = StringBuffer();

  //   for (var item in delta) {
  //     final String text = item['insert'] ?? '';
  ...
  //     htmlBuffer.write(formattedText);
  //   }
...
//   void htmlData()  {
//    String htmlString =
//                   '<b>Hi <font color="#e91e63">akshay </font><font color="#ffc107">how </font><font color="#673ab7">are you</font></b>';
//           //     _productDescriptionController.setText(htmlString);
//       /// index is optional
...
//   // _productDescriptionController.insertText(htmlString);
// // });
...
// void selectImage() {
//       String imagePath = "https://example.com/sample-image.jpg"; // Replace with actual image path
//       ref.read(manageVariantProvider.notifier).addImage(imagePath);
//       print("Images added: ${ref.read(manageVariantProvider)}");
//     }
  ...
  child: Scaffold(
      ...
      //              child: Column(
      //                children: [
      //                  // Quill Toolbar with basic formatting options
      ...
      //                        showStrikeThrough: false, // Hide strikethrough button
      //                        showListBullets: true, // Show bullet list button
      //                        showListNumbers: true, // Show numbered list button
      //                        showLink: false, // Show insert link button
      //                        showHeaderStyle: false, // Show heading style button
      //                        showLeftAlignment: false, // Show left alignment button
      //                        showCenterAlignment:
      //                            false, // Show center alignment button
      //                        showRightAlignment: false, // Hide right alignment button
      //                        showJustifyAlignment: false, // Show justify button
      //                        showUndo: false, // Show undo button
      //                        showRedo: false, // Show redo button
      ...
      //                    child: Container(
      //                      padding:
      //                          EdgeInsets.all(5), // Optional padding around the editor
      //                      decoration: BoxDecoration(
      //                        color: Colors.transparent, // Background color for the editor
      //                        border: Border.all(
      //                          color: Colors.grey, // Border color
      ...
      //                           final json = jsonEncode(_productDescriptionController.document.toDelta().toJson());
      //                           print(json);
      //                         },
                              
      //                         placeholder: "Product Description (optional) Type here...",
      //                            scrollable: true, padding: EdgeInsets.all(10)),
