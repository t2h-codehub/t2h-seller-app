            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  ...
                  //           },
                  //         );
                  //        // if (res) _future = loadVariantData();
                  //         if (res == true) {
                  //                       setState(() {
                  //                         _future = loadVariantData();
                  //                         _isChanged = true;  // Track changes after edit
                  //                       });
                  //                     }
                  //       },
                  //       child: Text(
                  ...
                  //       ),
                  //     ),
                  //     SizedBox(height: 8), // Space between Edit and Delete button
                  //     InkWell(
                  //       onTap: () async {
                  //         bool? confirmDelete = await showDialog(
                  //           context: context,
                  ...
                  //         if (confirmDelete == true) {
                  //           deleteVariantApiResModel = await _manageVariantController.deleteVariantValue(variant.id);
                  //           if (deleteVariantApiResModel.success == true) {
                  //             ScaffoldMessenger.of(context).showSnackBar(
                  //               SnackBar(content: Text('Variant deleted successfully')),
                  //             );
                  ...
                  //             setState(() {
                  //                           _future = loadVariantData();
                  //                           _isChanged = true; // Track changes after delete
                  //                         });
                  //           } else {
                  //             ScaffoldMessenger.of(context).showSnackBar(
                  //               SnackBar(content: Text('Failed to delete variant')),
