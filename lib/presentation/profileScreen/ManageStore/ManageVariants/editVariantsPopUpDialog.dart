...
//     BuildContext context, List<String> selectedTypes) async {
//   // Ensure adminVariantType is properly formatted as List<String>
//   List<String> allTypes = adminVariantType.map((type) => type.toString().trim().toLowerCase()).toList();
//   List<String> normalizedSelectedTypes = selectedTypes.map((type) => type.toString().trim().toLowerCase()).toList();

//   // Filter out already selected types
//   List<String> availableTypes = allTypes.where((type) => !normalizedSelectedTypes.contains(type)).toList();

//   // Debugging: Print to console
//   print("All Types: $allTypes");
//   print("Selected Types: $normalizedSelectedTypes");
...
//           Expanded(
//             child: availableTypes.isNotEmpty
//                 ? ListView.builder(
...
//                         InkWell(
//                           onTap: () {
//                             Navigator.pop(context, availableTypes[index]);
//                           },
//                           child: Container(
...
//                 : Center(
//                     child: Text(
//                       "No more variant types available",
...
//  Future<String?> showAddedVariantTypesModalSheet(
//     BuildContext context, List<String> selectedVariantTypes) async {
//   // Filter out already selected variant types
//  List<String> availableVariantTypes = adminVariantType
//     .where((type) => !selectedVariantTypes.contains(type))
//     .map((type) => type.toString()) // Ensure all values are Strings
//     .toList();
...
//           Divider(color: Colors.grey),
//           Expanded(
//             child: availableVariantTypes.isNotEmpty
//                 ? ListView.builder(
//                     itemCount: availableVariantTypes.length,
//                     shrinkWrap: true,
//                     physics: BouncingScrollPhysics(),
//                     itemBuilder: (context, index) => Column(
//                       children: [
//                         InkWell(
//                           onTap: () {
//                             Navigator.pop(context, availableVariantTypes[index]);
//                           },
//                           child: Container(
//                             padding: EdgeInsets.symmetric(vertical: 12),
//                             child: Center(
//                               child: Text(
//                                 availableVariantTypes[index],
//                                 style: TextStyle(fontSize: 16),
//                               ),
//                             ),
//                           ),
...
//               physics: BouncingScrollPhysics(),
//               itemBuilder: (context, index) {
//                 String variantValue = adminVariantValue[index]['valueTitle'];

//                 // Skip if the value is already selected
//                 if (selectedValues.contains(variantValue)) {
...
//                     InkWell(
//                       onTap: () {
//                         selectedString.complete(variantValue);
//                         Navigator.pop(context);
//                       },
//                       child: Container(
//                         margin: EdgeInsets.symmetric(vertical: 10),
//                         child: Center(child: Text(variantValue)),
//                       ),
//                     ),
//                     Divider(color: Colors.grey),
//                   ],
