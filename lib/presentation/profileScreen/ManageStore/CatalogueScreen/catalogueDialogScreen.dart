...
import 'package:swapnil_s_application4/data/productCategoryModel/catalogueCategoryFilterApiResModel.dart';
import 'package:swapnil_s_application4/data/productCategoryModel/filterCatalogueApiResModel.dart';
import 'package:swapnil_s_application4/data/productCategoryModel/filterDataModel.dart';
...
import 'package:swapnil_s_application4/presentation/profileScreen/ManageStore/CatalogueScreen/CatalogueController/catalogueController.dart';
import 'package:swapnil_s_application4/presentation/profileScreen/ManageStore/CatalogueScreen/filterCatelogueDataScreen.dart';
...
class _CatalogueDialogScreenState extends State<CatalogueDialogScreen> {
  ...
  CatalogueController _catalogueController = CatalogueController();
  ...
  Future<bool> getCatalogueFilter() async {
    ...
    if (catalogueCategoryFilterApiResModel.isNotEmpty) {
      catalogueCategoryFilterApiResModel.forEach((element) {
