...
import 'package:swapnil_s_application4/presentation/profileScreen/ManageStore/InstagramAuth/instagramAddProductScreen.dart';
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            child: Stack(
              children: [
                /// Catalogue Image
               if(widget.instagramAuthResModel['data'][index]['thumbnail_url'] == null ) Container(
