                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: () {
                                              ...
                                              Share.share(
                                                  "Check out my HelloProfile ${AppConstants.storeUrl}${_userDetailService.userDetailResponse?.user?.username}");
                                              (_userDetailService
                                                  .userDetailResponse
                                                  ?.user
                                                  ?.username !=
                                                  ...
                                                  "Check out my HelloProfile ${AppConstants.storeUrl}${_userDetailService.userDetailResponse?.user?.username}"))
                                                  : launchUrl(Uri.parse(
                                                  "Check out my HelloProfile ${AppConstants.storeUrl}${_userDetailService.userDetailResponse?.user?.id}"));
                                              // launchUrl(Uri.parse(
                                              //     "https://instagram.com/"));
                                            },
                                            child: Padding(
